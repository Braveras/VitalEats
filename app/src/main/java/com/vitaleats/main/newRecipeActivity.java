    ...
    private void createRecipe() {
        ...
        uploadTask.addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Recipe recipe = new Recipe(recipeTitle, recipeIngredients, recipeElaboration, recipeServingsStr, tvRecipeTime.getText().toString(), selectedRecipeType, selectedTags, imageUrlList, currentUserId, user.getDisplayName(), 0, new Date(), true);
